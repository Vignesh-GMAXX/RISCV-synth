...
set_input_delay -add_delay -clock vir_clk_i -max $IN_DELAY_MAX [get_ports {rst mem_bank_sel[*] dbg_sel[*]}]
set_input_delay -add_delay -clock vir_clk_i -min $IN_DELAY_MIN [get_ports {rst mem_bank_sel[*] dbg_sel[*]}]
...
########## FALSE PATHS ###########
# Reset and IO power indicators are asynchronous/static controls.
