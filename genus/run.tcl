...
set_db / .init_hdl_search_path [file join $PROJECT_ROOT design]
...
# READ ALL FILES
read_hdl [glob [file join $PROJECT_ROOT design *.v]]
...
read_sdc [file join $SCRIPT_DIR genus.sdc]
